...
const Rock: React.FC<{ boardsStore: PuzzleSession }> = ({ boardsStore }) => {
    ...
    return (
        ...
        <svg {...pieceBox(1, 1, size)} viewBox={viewBox(1, 1)}>
            <rect x={I} y={I + E} width={U - 2 * I} height={U - 2 * I} fill={PALETTE.rockSide} rx={R} ry={R} />
            <rect x={I} y={I} width={U - 2 * I} height={U - 2 * I} fill={PALETTE.rockFace} rx={R} ry={R} />
            <rect data-outline x={I} y={I} width={U - 2 * I} height={U - 2 * I + E} fill="none" strokeWidth={O} stroke={PALETTE.pieceOutline} rx={R} ry={R} />
        </svg>
    );
};
